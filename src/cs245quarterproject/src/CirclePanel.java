...
public class CirclePanel extends javax.swing.JPanel implements ChangeListener, ActionListener {
    ...
    /**
     * Incomplete method spawnButtons() shuffles the contents of the buttonList
     * which contains all of this panels circle buttons. It then sets the action
     * commands and icons of the first five buttons in the shuffled collection
     * to their designated color from Colors[]
     */
    ...
    /**
     * spawnLabel starts by setting the text of all labels to null then it
     * shuffles the list of labels it generates a random number and then picks
     * the color and text based on that number
     */
    ...
    /**
     * This method gets rid of the backgrounds of all the buttons in buttonList
     * and also registers this panel as their action and change listeners.
     */
    ...
    @Override
    /**
     * The method stateChanged is used to swap the pictures of a button when the
     * mouse is rolled over it. It gets the color by getting the source of the
     * change event ce and getting the action command of its source.
     *
     * It then gets the source's ButtonModel and checks to see if the mouse is
     * rolled over it. The sources icon is then set to the appropriate picture.
     *
    ...
    @Override
    /**
     * this method respawns the labels and buttons after 5 rounds it goes to the
     * next panel
     */
